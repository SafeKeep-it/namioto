...
public class align_basic : IAsyncLifetime
{
    ...
    public Task InitializeAsync()
    {
        ...
        _buffer.WriteTerminalSnapshotSvg("align_basic.right_alignment.svg");
        _buffer.WriteLayoutDebugSvg(_align, 10, 1, "align_basic.right_alignment.svg");
    ...
    [Fact]
    public void renders_content_at_right_edge()
    {
        row(0).ShouldBe("        AB");
    }
