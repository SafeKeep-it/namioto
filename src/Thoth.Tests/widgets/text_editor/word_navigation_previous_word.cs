...
public class word_navigation_previous_word
{
    readonly TextEditor _editor;
    readonly string _rendered;

    public word_navigation_previous_word()
    {
        ...
        screen.HandleKey(new('\0', ConsoleKey.LeftArrow, false, true, false));
        ...
        buffer.WriteTerminalSnapshotSvg("word_navigation_previous_word.alt_left.svg");
        buffer.WriteLayoutDebugSvg(_editor, 16, 1, "word_navigation_previous_word.alt_left.svg");
    }

    [Fact]
    public void when_alt_left_is_pressed_at_end_of_text_then_caret_moves_to_start_of_previous_word()
    {
        _editor.CaretIndex.ShouldBe(6);
    }

    [Fact]
    public void when_alt_left_is_pressed_then_text_content_remains_unchanged()
    {
