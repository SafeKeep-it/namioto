...
public class word_navigation_next_word
{
    readonly TextEditor _editor;
    readonly string _rendered;

    public word_navigation_next_word()
    {
        ...
        buffer.WriteTerminalSnapshotSvg("word_navigation_next_word.alt_right.svg");
        buffer.WriteLayoutDebugSvg(_editor, 16, 1, "word_navigation_next_word.alt_right.svg");
    }

    [Fact]
    public void when_alt_right_is_pressed_at_start_of_text_then_caret_moves_to_end_of_next_word()
    {
        _editor.CaretIndex.ShouldBe(5);
    }

    [Fact]
    public void when_alt_right_is_pressed_then_text_content_remains_unchanged()
    {
